...
import com.example.jwtauthentication.message.response.ResponseMessage;
...
public class AuthRestAPIs {
	...
	public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
		...
		User user = new User(signUpRequest.getName(), signUpRequest.getAddress(), 
								signUpRequest.getUsername(), signUpRequest.getEmail(),signUpRequest.getAccountnumber(),
								signUpRequest.getMobilenumber(),encoder.encode(signUpRequest.getPassword()));
